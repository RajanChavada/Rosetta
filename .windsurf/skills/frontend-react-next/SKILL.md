...
## Expert Intent
Implement high-fidelity, high-performance user interfaces. This skill enforces component modularity, strict prop-types/TS safety, and optimized rendering strategies (Server vs Client components) to ensure a premium user experience in **Rosetta**.
...
- **Core Stack**: follow patterns for **Svelte, Native mobile**.
