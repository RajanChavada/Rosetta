...
export const TARGETS = [
  { label: 'VSCode / Claude Code', path: 'CLAUDE.md', template: 'anthropic-claude.md', skillsDir: '.claude/skills' },
  { label: 'Cursor', path: '.cursorrules', template: 'cursorrules.md', skillsDir: '.cursor/rules' },
  ...
  { label: 'Windsurf', path: '.windsurf/rules/rosetta-rules.md', template: 'windsurf-rules.md', skillsDir: '.windsurf/skills' },
